...
public class SlowingTower extends Tower {
	...
	public SlowingTower(int tileWidth, int tileHeight, int xIndex, int yIndex, Group _ennemies) {
		...
		stage=new Stage();
		//-- the tower image
		Texture t = new Texture(Gdx.files.internal("GameScreenMedia/towers/tower2.png"));
		_img = new Image(t);
		_img.setSize(32,32);
		addActor(_img);
		_ennemi=_ennemies;
	...
	private void Slow(final Foe bestT)
	 {
	  final float y=bestT.get_speed();
	  bestT.set_speed(0.5f);
