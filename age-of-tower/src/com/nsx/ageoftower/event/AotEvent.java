...
public class AotEvent extends Event{
	...
	static public enum Type {
		...
		/** Déclanchþýpar le hud lors du clique sur le bouton de lancement de vagues */ 
		launchButtonPressed,
		/** Déclanchþýpar le hud lors du clique sur level selection sur le widget gameover */ 
		goToLevelSelection,
		/** Déclanchþýpar le hud lors duclique sur restart en etant sur le GameOver widget */ 
		restartLevel,
		/** Déclanchþýpar le hud lors duclique sur restart en etant sur le GameOver widget */
		gameOver,
		PauseButtonPressed
